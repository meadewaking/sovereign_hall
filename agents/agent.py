...
请提炼新增证据和对投资判断有影响的信息，不复述搜索结果；如展开能提高判断质量，可以充分展开。
按以下格式：
## 新增证据
- 来源标题/事实/影响
## 判断变化
...
请输出搜索信息带来的新增洞察，不复述背景。
若搜索信息与任务无关，回答“无新增证据”，并说明是否维持原判断。
格式：
## 证据
- 已验证事实：...
- 推断：...
## 投资含义
- 买入/卖出/观望；置信度；关键触发/否决条件
## 缺口
- 仍需验证的1-2项"""
...
2. 识别3-5个值得关注的投资标的
3. 给出投资建议和风险提示
4. 只列3-5个候选标的，逐一说明证据、催化、主要风险和否决条件
5. 不复述资料原文；没有足够证据的标的不要推荐
6. 可以充分展开能提升判断质量的交叉验证和反例
"""
